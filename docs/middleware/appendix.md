...
| emi_overdue | Send notification and show full screen banner on app open | <a href = "https://finbox-cdn.s3.ap-south-1.amazonaws.com/docs/assets/servicing/Notification-lI.png" target="_blank"> Sample Notification </a> <a href = "https://finbox-cdn.s3.ap-south-1.amazonaws.com/docs/assets/servicing/Banner-lI.png" target="_blank"> Sample Banner </a> |
...
| emi_paid | Send notification for payment confirmation | <a href = "https://finbox-cdn.s3.ap-south-1.amazonaws.com/docs/assets/servicing/Notification-lI.png" target="_blank"> Sample Notification </a> <a href = "https://finbox-cdn.s3.ap-south-1.amazonaws.com/docs/assets/servicing/Banner-lI.png" target="_blank"> Sample Banner </a> |
